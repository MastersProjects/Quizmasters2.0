...
include_once 'resources/navigation.php';
	...
	?>
<div class="container">
<div class="col-md-12">		<h1>Dein Profil</h1></div>
		<div class="col-md-8">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="inputFirstname">Vorname</label> <input type="text"
							class="form-control" id="inputFirstname" name="surname"
							placeholder="Vorname"
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="inputPassword">Passwort</label><input type="password"
							class="form-control" name="passwordOne" id="inputPassword"
...
<div class = "col-md-4">
<img src="img/placeholder.jpg" alt="Cinque Terre" width="304" height="236">
</div>
</div>
	<hr />
